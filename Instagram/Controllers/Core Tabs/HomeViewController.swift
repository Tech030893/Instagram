...
class HomeViewController: UIViewController
{
    ...
    {
        let user = User(username: "@snehal_tawade", bio: "", name: (first: "", last: ""), profilePhoto: URL(string: "https://www.google.com")!, birthDate: Date(), gender: .female, counts: UserCount(followers: 1, following: 1, posts: 1), joinDate: Date())
        ...
        for x in 0..<2
        {
            comments.append(PostComment(identifier: "\(x)", username: "@Rashmi", text: "This is the best post I've seen", createdDate: Date(), likes: []))
        }

...
extension ProfileViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout
{
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath)
    {
        ...
        let user = User(username: "snehal", bio: "", name: (first: "", last: ""), profilePhoto: URL(string: "https://www.google.com")!, birthDate: Date(), gender: .female, counts: UserCount(followers: 1, following: 1, posts: 1), joinDate: Date())
...
extension ProfileViewController: ProfileInfoHeaderCollectionReusableViewDelegate
{
    ...
    func profileHeaderDidTapFollowersButton(_ header: ProfileInfoHeaderCollectionReusableView)
    {
        ...
        for x in 0..<10 {
            mockData.append(UserRelationship(username: "@snehal", name: "Snehal Tawade", type: x % 2 == 0 ? .following : .not_following))
        }
